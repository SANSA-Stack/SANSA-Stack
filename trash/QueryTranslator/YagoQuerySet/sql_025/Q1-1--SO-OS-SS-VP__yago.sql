SELECT tab7.a AS a , tab0.GivenName AS GivenName , tab4.p AS p , tab6.switzerland AS switzerland , tab9.germany AS germany , tab2.scientist AS scientist , tab8.city2 AS city2 , tab1.FamilyName AS FamilyName , tab5.city AS city 
