...
public interface CanParseRdf {
    ...
    PrefixMap parsePrefixes(InputStream inputStream, Configuration conf) throws IOException;

    default PrefixMap parsePrefixes(FileSystem fs, Path path, Configuration conf) throws IOException {
