...
import net.sansa_stack.query.spark.dataset.DatasetOps._
import org.apache.jena.graph.{Node, NodeFactory}
import org.apache.spark.SparkConf

import scala.collection.JavaConverters._

class DatasetTests extends FunSuite with DataFrameSuiteBase {
  ...
  override def conf(): SparkConf = {
    ...
    conf
      ...
      .set("spark.kryo.registrator", String.join(", ",
        ...
        "net.sansa_stack.query.spark.graph.jena.serialization.Registrator"))
    conf
  }
