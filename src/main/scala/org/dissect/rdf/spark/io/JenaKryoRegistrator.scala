...
class JenaKryoRegistrator extends KryoRegistrator {
  override def registerClasses(kryo: Kryo) {
    ...
    kryo.register(classOf[org.apache.jena.graph.Node_ANY], new VariableNodeSerializer)
    ...
    kryo.register(classOf[org.dissect.rdf.spark.model.SparkRDDGraphOps[JenaSparkRDD]])
