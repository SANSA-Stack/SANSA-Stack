 ...
 */
case class RdfPartitionDefault(val subjectType: Byte, val predicate: String, val objectType: Byte, val datatype: String, val langTagPresent: Boolean) {//val langTag: String) {
