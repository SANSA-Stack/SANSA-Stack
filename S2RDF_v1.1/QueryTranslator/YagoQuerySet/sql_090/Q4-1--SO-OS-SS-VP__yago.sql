SELECT tab2.p2 AS p2 , tab2.p1 AS p1 , tab0.name1 AS name1 , tab1.name2 AS name2 , tab4.city AS city 
 ...
 ON(tab2.p1=tab3.p1 AND tab4.city=tab3.city)
...
------
_L_isMarriedTo_B_$$3$$	4	OS	_L_isMarriedTo_B_/_L_wasBornIn_B_
