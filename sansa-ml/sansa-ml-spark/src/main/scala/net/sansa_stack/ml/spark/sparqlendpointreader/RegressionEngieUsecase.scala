...
class RegressionEngieUsecase {
  ...
  def setHdfsHost(hdfsHost: String): RegressionEngieUsecase = {
    if (hdfsHost == null) {
  ...
  def setHost(host: String): RegressionEngieUsecase = {
    if (host == null) {
  ...
  def setSparql(sparql: String): RegressionEngieUsecase = {
    if (sparql == null) {
      throw new Exception("URL can not be null")
    }
  ...
  def setPort(port: String): RegressionEngieUsecase = {
    if (port == null) {
  ...
  def setSparqlQuery(sparqlQuery: String): RegressionEngieUsecase = {
    if (sparqlQuery == null) {
