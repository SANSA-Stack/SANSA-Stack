...
public class OutputContext {
    ...
    public OutputContext(Configuration hadoopConfiguration,
        FileSystem targetFileFs, Path targetFile,
        FileSystem partitionFolderFs, Path effPartitionFolder,
                         boolean allowOverwriteFiles, boolean deletePartitionFolderAfterMerge) {
        this.targetFileFs = targetFileFs;
        this.targetFile = targetFile;
        this.partitionFolderFs = partitionFolderFs;
        this.partitionFolder = effPartitionFolder;
