 ...
 *
 *
 * @param distinguishStringLiterals
 * @param partitionPerLangTag Whether to create individual partition for each langugae tag
 */
abstract class RdfPartitionerBase(
                                   distinguishStringLiterals: Boolean = false,
                                   partitionPerLangTag: Boolean = false
                                 )
  extends RdfPartitioner[RdfPartitionStateDefault] with Serializable
{
  ...
  */
  ...
  protected val intDTypeURIs = Set(XSDDatatype.XSDnegativeInteger, XSDDatatype.XSDpositiveInteger,
