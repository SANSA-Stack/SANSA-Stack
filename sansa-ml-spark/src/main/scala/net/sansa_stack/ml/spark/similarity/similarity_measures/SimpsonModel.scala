...
class SimpsonModel extends GenericSimilarityEstimator {
  ...
  override val estimator_name: String = "SimpsonSimilarityEstimator"
  ...
  override def nearestNeighbors(df_A: DataFrame, key: Vector, k: Int, key_uri: String = "unknown", value_column: String = "simpson_similarity", keep_key_uri_column: Boolean = false): DataFrame = {
