...
class Similarity_Experiment_Meta_Graph_Factory {
  ...
  def transform(df: DataFrame)
               ...
               (metagraph_element_relation: String = "element",
                ...
                metagraph_experiment_datetime_relation: String = "experiment_datetime"): RDD[Triple] = {
    ...
    // create Central Node
    val metagraph_experiment_hash: String = metagraph_experiment_type + metagraph_experiment_name + metagraph_evaluation_datetime
    ...
    spark.sqlContext.sparkContext.parallelize(Seq(central_node_triples))
  }
