...
//  */
//class OWLSchemaExtractor(session : SparkSession) extends Logging{
//
//  val properties = List(
//    OWL2.onProperty,
//    OWL2.someValuesFrom, OWL2.allValuesFrom, OWL2.hasValue, OWL2.hasValue,
//    OWL2.cardinality, OWL2.minCardinality, OWL2.maxCardinality)
//    .map(p => p.getURI)
//
//
//  /**
